...
from stats import meanimport math, random
    ...
    for k in [1, 3, 5, 7]:        
        ...
        for location, actual_language in cities:            
            other_cities = [other_city                           
                ...
                if other_city != (location, actual_language)]            predicted_language = knn_classify(k, other_cities, location)            if predicted_language == actual_language:                  num_correct += 1        print(k, "neighbor[s]:", num_correct, "correct out of", len(cities))

    # 3. classfy and plot grid with k = 1, 3, 5
    classify_and_plot_grid()

# 4. dim 1~100, get the avg distance and min distance 
