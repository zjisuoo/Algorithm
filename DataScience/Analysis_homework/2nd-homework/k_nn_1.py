...
def plot_cities():
    ...
    for label, (x, y) in plots.items():
        plt.scatter(x, y, color = colors[language], marker = markers[label],
...
if __name__ == "__main__":
    ...
    for k in [1, 3, 5, 7]:
        ...
        print("K : ", k, "correct out of", len(airquality))
...
for i in range(len(airquality)) :
    if 1 <= airquality[i][0][0] <= 2 and 0 <= airquality[i][0][1] <= 15 and predicted_aircondition[i] == 'GOOD_AIR' :
        tp += 1
    elif 3 <= airquality[i][0][0] <= 5 and 31 <= airquality[i][0][1] <=75 and predicted_aircondition[i] == 'NORMAL_AIR' :
        tp += 1
    elif 6 <= airquality[i][0][0] <= 8 and 75 <= airquality[i][0][1] and predicted_aircondition[i] == 'BAD_AIR' :
        tp += 1

# TN : 실제 False, False 라 예측
for i in range(len(airquality)) :
    if 1 <= airquality[i][0][0] <= 2 and 0 <= airquality[i][0][1] <= 15 and predicted_aircondition[i] == 'NORMAL_AIR' or 'BAD_AIR' :
        tn += 1
    elif 3 <= airquality[i][0][0] <= 5 and 31 <= airquality[i][0][1] <=75 and predicted_aircondition[i] == 'GOOD_AIR' or 'BAD_AIR' :
        tn += 1
    elif 6 <= airquality[i][0][0] <= 8 and 75 <= airquality[i][0][1] and predicted_aircondition[i] == 'GOOD_AIR' or 'NORMAL_AIR' :
        tn += 1

# FP : 실제 False, True 라 예측
for i in range(len(airquality)) :
    if 3 <= airquality[i][0][0] and 16 <= airquality[i][0][1] and predicted_aircondition[i] == 'GOOD_AIR' :
        fp += 1
    elif 1 <= airquality[i][0][0] <= 4 and 7 <= airquality[i][0][0] and 0 <= airquality[i][0][1] <= 15 and 75 <= airquality[i][0][1] and predicted_aircondition[i] == 'NORMAL_AIR' :
        fp += 1
    elif airquality[i][0][0] <= 7 and airquality[i][0][1] <= 74 and predicted_aircondition[i] == 'BAD_AIR' :
        fp += 1

# FN : 실제 False, False 라 예측
for i in range(len(airquality)) :
    if 3 <= airquality[i][0][0] and 16 <= airquality[i][0][1] and predicted_aircondition[i] == 'NORMAL_AIR' or 'BAD_AIR' :
        fn += 1
    elif 1 <= airquality[i][0][0] <= 4 and 7 <= airquality[i][0][0] and 0 <= airquality[i][0][1] <= 15 and 75 <= airquality[i][0][1] and predicted_aircondition[i] == 'GOOD_AIR' or 'BAD_AIR' :
        fn += 1
    elif airquality[i][0][0] <= 7 and airquality[i][0][1] <= 74 and predicted_aircondition[i] == 'GOOD_AIR' or 'NORMAL_AIR' :
        fn += 1
